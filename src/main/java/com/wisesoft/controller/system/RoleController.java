...
public class RoleController extends BaseController {
	...
	public PageView findByPage(String pageNow,
        ...
        pageView.setRecords(roleMapper.findRolePage(roleFormMap)); // 不调用默认分页,调用自已的mapper中findRolePage
		return pageView;
	}
	...
	public String addEntity() throws Exception {
		RoleFormMap roleFormMap = getFormMap(RoleFormMap.class);
		roleFormMap.set("id", UUIDUtil.create());
	...
	public String deleteEntity() throws Exception {
		...
		for (String id : ids) {
			...
			roleMapper.deleteById(roleFormMap);
		}
		return "success";
	}
