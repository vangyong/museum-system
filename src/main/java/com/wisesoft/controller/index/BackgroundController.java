...
import com.wisesoft.mapper.system.RoleMapper;
...
public class BackgroundController extends BaseController {
	...
	public String login(String username, String password, HttpServletRequest request) {
		try {
			...
			userLogin.put("ID", UUIDUtil.create());
	...
	public String index(Model model) throws Exception {
		...
		UserRoleFormMap userResFormMap = new UserRoleFormMap();
		userResFormMap.put("USERID", userFormMap.get("ID"));
		...
		userResFormMap.put("ROLEID", userFormMap.get("ROLEID"));
		//userResFormMap.put("roles", roles);
		List<ResFormMap> mps = resourcesMapper.findUserRoleRes(userResFormMap);
	...
	/**
	 * @title: logout
	 * @description: 使用权限管理工具进行用户的退出，注销登录
	 * @return: String
	 */
