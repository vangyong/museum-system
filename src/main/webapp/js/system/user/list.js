...
$(function() {
	...
	$("#editUser").click("click", function() {
		editUser();
	});
	$("#delUser").click("click", function() {
		delUser();
	});
	$("#userPermissions").click("click", function() {
		userPermissions();
	});
});
function editUser() {
...
function userPermissions() {
	...
	alert(cbox);
	var url = rootPath + '/resources/userPermissions.shtml?USERID='+cbox;
	pageii = layer.open({
		title : "用户授权",
		type : 2,
		area : [ "700px", "80%" ],
