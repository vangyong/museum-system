...
<title>登录－文保档案系统</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<link rel="stylesheet"	href="${pageContext.servletContext.contextPath }/css/min.css">
<link rel="stylesheet"	href="${pageContext.servletContext.contextPath }/css/login/login.css">
<link	href="${pageContext.servletContext.contextPath }/css/css.css"	rel="stylesheet" type="text/css">
<!--[if lt IE 9]> 
...
<body onload="javascript:to_top()" 
	style="background-image: url('${pageContext.servletContext.contextPath }/images/login/background.jpg');margin-top:0px;background-repeat:no-repeat;background-size: 100% auto;">
		...
		<form id="loginform" name="loginform" class="form-vertical"
			...
			<div class="control-group normal_text">
				<table style="width: 100%">
					<tr>
						<td align="left"><img
							src="${pageContext.servletContext.contextPath }/images/login/logo_left.png"
							alt="Logo"></td>
							<td align="center" style="font-weight: bold;color: gray;">文物保护工程档案研究与利用管理系统</td>
						<td align="right"><img
							src="${pageContext.servletContext.contextPath }/images/login/logo_left.png"
							alt="Logo"></td>
					</tr>
				...
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly" style="background: #28b779"><img
							src="${pageContext.servletContext.contextPath }/images/login/account.png"
				...
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly"><img
							src="${pageContext.servletContext.contextPath }/images/login/lock.png"
