...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post" action="${ctx}/user/addEntity.shtml">
	<section class="panel panel-default">
		<div class="panel-body">
			...
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group" id="selectRole" data-url="/role/selectRole.shtml"></div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
